...
export const Temerarioexterior = () => {

    const [slides, setSlides] = useState("blue");
    ...
    const colors = [
        {
            ...
            color: "#23304A",
            type: "video",
            src: "https://res.cloudinary.com/dhlflr2cc/video/upload/v1780075107/Temerario-Exterior_m7lehw.mp4",
        },
        {
            name: "yellow",
            color: "#ffd23d",
            type: "image",
            src: "https://res.cloudinary.com/dhlflr2cc/image/upload/v1780075107/yellow_vkth9l.jpg",
        },
        {
            name: "orange",
            color: "#e64a37",
            type: "image",
            src: "https://res.cloudinary.com/dhlflr2cc/image/upload/v1780075095/orange_shqc1e.jpg",
        },
        {
            name: "green",
            color: "#7dc242",
            type: "image",
            src: "https://res.cloudinary.com/dhlflr2cc/image/upload/v1780075091/green_nu1cla.jpg",
        },
    ];
        ...
        <section className="w-full bg-black overflow-hidden">
            ...
            <div className="text-white text-center px-5 lg:px-20 py-2">
                ...
                <p className="text-gray-300 leading-relaxed text-sm lg:text-base text-justify">
                    Temerario marks a new Lamborghini design milestone,
                    with bold lines, futuristic hexagonal DRLs,
                    an exposed engine and a functional spoiler
