    ...
    const colors = [
        {
            ...
            color: "#ff6700",
            type: "video",
            src: "https://res.cloudinary.com/dhlflr2cc/video/upload/v1780080856/Revuelto-Exterior_bc1itt.mp4",
        },
        {
            name: "purple",
            color: "#b27cb6",
            type: "image",
            src: "https://res.cloudinary.com/dhlflr2cc/image/upload/v1780080842/purple_fyjzkx.jpg",
        },
        {
            name: "green",
            color: "#d2ff1d",
            type: "image",
            src: "https://res.cloudinary.com/dhlflr2cc/image/upload/v1780080867/yellow_rvttjf.jpg",
        },
        {
            name: "navy",
            color: "#1a2a3f",
            type: "image",
            src: "https://res.cloudinary.com/dhlflr2cc/image/upload/v1780080826/blue_cf2sk8.jpg",
        },
    ];
